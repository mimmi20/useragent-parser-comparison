...
//                $resultHelper->storeResult('0', $proId, $uaId, $singleTestData, $proVersion);
                ...
                $statementInsertUaHeaders->bindValue(':headers', json_encode($headers, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_THROW_ON_ERROR | JSON_PRETTY_PRINT));
                $statementInsertUaHeaders->bindValue(':userAgent', $headers['user-agent'] ?? null);
                $statementInsertUaHeaders->bindValue(':deviceStockUa', $headers['device-stock-ua'] ?? $headers['http-device-stock-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xDeviceUserAgent', $headers['x-device-user-agent'] ?? $headers['http-x-device-user-agent'] ?? null);
                $statementInsertUaHeaders->bindValue(':xSkyfireVersion', $headers['x-skyfire-version'] ?? $headers['http-x-skyfire-version'] ?? null);
                $statementInsertUaHeaders->bindValue(':xSkyfirePhone', $headers['x-skyfire-phone'] ?? $headers['http-x-skyfire-phone'] ?? null);
                $statementInsertUaHeaders->bindValue(':xBluecoatVia', $headers['x-bluecoat-via'] ?? $headers['http-x-bluecoat-via'] ?? null);
                $statementInsertUaHeaders->bindValue(':xOperaminiPhoneUa', $headers['x-operamini-phone-ua'] ?? $headers['http-x-operamini-phone-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xOperaminiPhone', $headers['x-operamini-phone'] ?? $headers['http-x-operamini-phone'] ?? null);
                $statementInsertUaHeaders->bindValue(':xUcbrowserUa', $headers['x-ucbrowser-ua'] ?? $headers['http-x-ucbrowser-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xUcbrowserDeviceUa', $headers['x-ucbrowser-device-ua'] ?? $headers['http-x-ucbrowser-device-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xUcbrowserDevice', $headers['x-ucbrowser-device'] ?? $headers['http-x-ucbrowser-device'] ?? null);
                $statementInsertUaHeaders->bindValue(':xUcbrowserPhoneUa', $headers['x-ucbrowser-phone-ua'] ?? $headers['http-x-ucbrowser-phone-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xUcbrowserPhone', $headers['x-ucbrowser-phone'] ?? $headers['http-x-ucbrowser-phone'] ?? null);
                $statementInsertUaHeaders->bindValue(':xOriginalUserAgent', $headers['x-original-user-agent'] ?? $headers['http-x-original-user-agent'] ?? null);
                $statementInsertUaHeaders->bindValue(':xBoltPhoneUa', $headers['x-bolt-phone-ua'] ?? $headers['http-x-bolt-phone-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xMobileUa', $headers['x-mobile-ua'] ?? $headers['http-x-mobile-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xRequestedWith', $headers['x-requested-with'] ?? $headers['http-x-requested-with'] ??null);
                $statementInsertUaHeaders->bindValue(':uaOs', $headers['ua-os'] ?? $headers['http-ua-os'] ?? null);
                $statementInsertUaHeaders->bindValue(':baiduFlyflow', $headers['baidu-flyflow'] ?? $headers['http-baidu-flyflow'] ?? null);
                $statementInsertUaHeaders->bindValue(':xWapProfile', $headers['x-wap-profile'] ?? $headers['http-x-wap-profile'] ?? null);
                $statementInsertUaHeaders->bindValue(':xPuffinUa', $headers['x-puffin-ua'] ?? $headers['http-x-puffin-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':xMobileGateway', $headers['x-mobile-gateway'] ?? $headers['http-x-mobile-gateway'] ?? null);
                $statementInsertUaHeaders->bindValue(':xNbContent', $headers['x-nb-content'] ?? $headers['http-x-nb-content'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUa', $headers['sec-ch-ua'] ?? $headers['http-sec-ch-ua'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaArch', $headers['sec-ch-ua-arch'] ?? $headers['http-sec-ch-ua-arch'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaBitness', $headers['sec-ch-ua-bitness'] ?? $headers['http-sec-ch-ua-bitness'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaFullVersion', $headers['sec-ch-ua-full-version'] ?? $headers['http-sec-ch-ua-full-version'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaFullVersionList', $headers['sec-ch-ua-full-version-list'] ?? $headers['http-sec-ch-ua-full-version-list'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaMobile', $headers['sec-ch-ua-mobile'] ?? $headers['http-sec-ch-ua-mobile'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaModel', $headers['sec-ch-ua-model'] ?? $headers['http-sec-ch-ua-model'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaPlatform', $headers['sec-ch-ua-platform'] ?? $headers['http-sec-ch-ua-platform'] ?? null);
                $statementInsertUaHeaders->bindValue(':secChUaPlatformVersion', $headers['sec-ch-ua-platform-version'] ?? $headers['http-sec-ch-ua-platform-version'] ?? null);
