import DeviceDetector from 'device-detector-node';
import packageInfo from 'device-detector-node/package.json' with { type: 'json' };
  ...
  if (r !== null) {
    output.result.parsed = {
      ...
      engine: {
        ...
        version: r.client && r.client.engine_version ? r.client.engine_version : null,
        manufacturer: null,
      },
      raw: r,
    };
